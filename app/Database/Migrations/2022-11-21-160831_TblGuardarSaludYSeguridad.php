...
class TblGuardarSaludYSeguridad extends Migration
{
    public function up()
    {
        ...
        $this->forge->createTable('tbl_guardar_salud_y_seguridad');
        //$this->db->enableForeignKeyChecks();
    }

    public function down()
    {
        $this->forge->dropTable('tbl_guardar_salud_y_seguridad');
    }
}