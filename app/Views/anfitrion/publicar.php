                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="text-left">
                                        <img value='<?= old('foto') ?>' id="imagenPre1" width="118" height="50" src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar img-thumbnail rounded-circle" alt="avatar">
                                        <h6></h6>
                                        <button type="button" class="btn-warning">
                                            <i class="fa fa-camera"></i> Subir foto
                                            <input value='<?= old('foto') ?>' id="foto1" type="file" name="foto[]" class="text-left left-block file-upload">
                                        </button>
                                    </div>
                                </div>
                                <!-- segunda columna -->
                                ...
                                <div class="col-md-5">
                                    <label class="label">Agrega una foto</label>
                                    <div class="text-left">
                                        <img value='<?= old('foto') ?>' id="imagenPre2" width="118" height="50" src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar img-thumbnail rounded-circle" alt="avatar">
                                        <h6></h6>
                                        <button type="button" class="btn-warning">
                                            <i class="fa fa-camera"></i> Subir foto
                                            <input value='<?= old('foto') ?>' id="foto2" type="file" name="foto[]" class="text-left left-block file-upload">
                                        </button>
                                    </div>
                                </div>
                                <!-- tercera columna -->
                                <div class="col-md-2">
                                    <label class="label">Agrega una foto</label>
                                    <div class="text-left">
                                        <img value='<?= old('foto') ?>' id="imagenPre3" width="118" height="50" src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" class="avatar img-thumbnail rounded-circle" alt="avatar">
                                        <h6></h6>
                                        <button type="button" class="btn-warning">
                                            <i class="fa fa-camera"></i> Subir foto
                                            <input value='<?= old('foto') ?>' id="foto3" type="file" name="foto[]" class="text-left left-block file-upload">
                                        </button><br><br><br>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control has-icons-left has-icons-right">
                                        <input name='precio' value='<?= old('precio') ?>' class="input" type="number" placeholder="$100.00" min="0" max="1000">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control has-icons-left has-icons-right">
                                        <input name='descuento' value='<?= old('descuento') ?>' class="input" type="number" placeholder="10%" min="0" max="100">
                                        <span class="icon is-small is-left">
                                            <i class="fas fa-dollar-sign"></i>
                                        </span><br><br>
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='adultos' value='<?= old('adultos') ?>' class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='menores' value='<?= old('menores') ?>' class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='bebes' value='<?= old('bebes') ?>' class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='mascotas' value='<?= old('mascotas') ?>' class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div><br>
