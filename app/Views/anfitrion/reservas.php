    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php else : ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($reservas as $keyReserva) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#Modal<?= $keyReserva->idPago ?>" data-backdrop="false" data-toggle="modal" class="btn btn-info"><i class="fas fa-thin fa-eye" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
                ...
                <?php foreach ($reservas as $keyReserva) : ?>
                    <div class="modal" id="Modal<?= $keyReserva->idPago ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            ...
            <?php else : ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($historial as $keyHistorial) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#Modal<?= $keyHistorial->idPago ?>" data-backdrop="false" data-toggle="modal" class="btn btn-info"><i class="fas fa-thin fa-eye" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
                ...
                <?php foreach ($historial as $keyHistorial) : ?>
                    <div class="modal" id="Modal<?= $keyHistorial->idPago ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
