                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <div class="btn-group" role="group">
                            <button id="btnGroupDrop1" type="button" class="btn write" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <a class="navbar-brand" href="#"><img src="/img/linicio.png" class="img-fluid"
                                        width="50px" height="30px" alt="">
                            </button>
                            <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                <li>
                                    <a class="dropdown-item"
                                        href="<?=base_url(route_to('anfitrionBusqueda'))?>">Perfil</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="<?=base_url(route_to('anfitrionBusqueda'))?>">Buscar</a>
                                </li>
                                <li>
