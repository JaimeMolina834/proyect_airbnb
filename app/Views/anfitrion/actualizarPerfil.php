                                    ...
                                    <div class="col">
                                        ...
                                        <div class="control has-icons-left has-icons-right">
                                            <input name='email'
                                                ...
                                                class="input" type="" placeholder="email@gmail.com">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="control">
                                            <input name='numeroTelefono'
                                                ...
                                                class="input" type="number" placeholder="75757575" maxlength="8">
                                        </div>
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input name='descripcion'
                                        value='<?php if(old('descripcion')!=null):?><?=old('descripcion')?><?php else:?><?=$anfitrion[0]->descripcion?><?php endif;?>'
                                        class="input" type="text" placeholder="Una breve descripcion de ti">
                                </div>
