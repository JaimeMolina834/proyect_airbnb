        ...
        <div class="row ">
            <div class="form-row">
                <div class="card border-dark">
                    ...
                    <div class="col-md-12">
                        <label class="h2 text-dark">Anfitrion: </label> <label
                            class="h3">@<?= $usuario[0]->username ?></label>
                    </div>

                    <div class="col-md-12">
                        <label class="h2 text-dark">Tipo de Hospedaje: </label> <label class="h4">
                            <?= $tipoHospedaje[0]->tipoHospedaje ?></label>
                    </div>

                    <div class="col-md-12">
                        <label class="h2 text-dark">Ubicación: </label> <label
                            class="h4"><?= $pais[0]->pais . ', ' . $departamento[0]->departamento . ', ' . $municipio[0]->municipio . ' - ' . $servicio[0]->direccion  ?></label>
                        <br><br>
                    </div>
                    ...
                    <div class="col-5 justify-content-center mx-auto">
                        ...
                        <label class="h6">Se registro <?= $anfitrion[0]->date_create->humanize(); ?></label>
                        <?php else : ?>
                        <img class="img-thumbnail" src="/img/perfiles/default.jpg" alt="">
                        <label class="h5">Se registro <?= $anfitrion[0]->date_create->humanize(); ?></label>
                        <?php endif; ?>
                    </div>
