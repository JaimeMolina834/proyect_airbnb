        ...
        <div class="col-md-6 m-auto">
            <div class="card border-0 shadow">
                <div class="card-body">
                    ...
                    <form
                        action="<?= base_url('anfitrion/ActualizarServicio') ?>?id=<?= password_hash($servicio[0]->idServicio,PASSWORD_DEFAULT)?>"
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="control">
                                        <input name='nombre'
                                            value='<?php if(old('nombre') != null): ?><?= old('nombre') ?><?php else: ?><?= $servicio[0]->nombre ?><?php endif; ?>'
                                            class="input" type="text" placeholder="Ej: Servicio Cabañas">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control select is-link">
                                        <select name='idTipoHospedaje'>
                                            ...
                                            <?php foreach ($tipoHospedajes as $key) : ?>
                                            <option value="<?= $key->idTipoHospedaje ?>"
                                                <?php if ($key->idTipoHospedaje == $servicio[0]->idTipoHospedaje) : ?>selected<?php endif; ?>>
                                                <?= $key->tipoHospedaje ?></option>
                                            <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="control">
                                        <input name='descripcion'
                                            value='<?php if(old('descripcion') != null): ?><?= old('descripcion') ?><?php else: ?><?=$servicio[0]->descripcion?><?php endif; ?>'
                                            class="input" type="text" placeholder="Ej: Lugar turistico">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control has-icons-left has-icons-right">
                                        <input name='precio'
                                            value='<?php if(old('precio') != null): ?><?= old('precio') ?><?php else: ?><?=$tarifa[0]->precio?><?php endif; ?>'
                                            class="input" type="number" placeholder="$100.00" min="0" max="1000">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="control">
                                        <input name='direccion'
                                            value='<?php if(old('direccion') != null): ?><?= old('direccion') ?><?php else: ?><?=$servicio[0]->direccion?><?php endif;?>'
                                            class="input" type="text" placeholder="Ej: 3Av Norte." />
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control has-icons-left has-icons-right">
                                        <input name='descuento'
                                            value='<?php if(old('descuento') != null): ?><?= old('descuento') ?><?php else:?><?=$tarifa[0]->descuento?><?php endif;?>'
                                            class="input" type="number" placeholder="10%" min="0" max="100">
                                        <span class="icon is-small is-left">
                                            <i class="fas fa-dollar-sign"></i>
                                        </span><br><br>
                                    </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='adultos'
                                            value='<?php if(old('adultos') != null): ?><?= old('adultos') ?><?php else:?><?=$huespedes[0]->adulto?><?php endif;?>'
                                            class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='menores'
                                            value='<?php if(old('menores') != null): ?><?= old('menores') ?><?php else:?><?=$huespedes[0]->menores?><?php endif;?>'
                                            class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='bebes'
                                            value='<?php if(old('bebes') != null): ?><?= old('bebes') ?><?php else: ?><?=$huespedes[0]->bebes?><?php endif;?>'
                                            class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="control">
                                        <input name='mascotas'
                                            value='<?php if(old('mascotas') != null): ?><?= old('mascotas') ?><?php else: ?><?=$huespedes[0]->mascotas?><?php endif; ?>'
                                            class="input" type="number" placeholder="Cantidad" min="0" max="10">
                                    </div><br>
