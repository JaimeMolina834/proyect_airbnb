...
class AnfitrionesModel extends Model{
    ...
    protected $allowedFields = ['descripcion','puntuacion','cuentaBanco','banco','totalPuntuacion','idUsuario','idiomaPrimario','idiomaSecundario','idiomaExtra'];
...
/*--Funcion para buscar el idioma correspondiente al de anfitrion----------------------------------------*/
    public function agregarIdiomaPrimario(string $idIdioma){
        $row = $this->db()->table('tbl_idiomas')->where('idIdioma',$idIdioma)->get()->getFirstRow();
        if($row !== null){
...
/*--Funcion para buscar el idioma correspondiente al de anfitrion----------------------------------------*/
    public function agregarIdiomaSecundario(string $idIdioma){
        $row = $this->db()->table('tbl_idiomas')->where('idIdioma',$idIdioma)->get()->getFirstRow();
        if($row !== null){
...
/*--Funcion para buscar el idioma correspondiente al de anfitrion----------------------------------------*/
    public function agregarIdiomaExtra(string $idIdioma){
        $row = $this->db()->table('tbl_idiomas')->where('idIdioma',$idIdioma)->get()->getFirstRow();
        if($row !== null){
