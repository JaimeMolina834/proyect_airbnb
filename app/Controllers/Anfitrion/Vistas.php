...
/*---------------------------------------------------------------------------------------------------------------------*/
    public function misReservas(){
        ...
        $date = date('Y-m-d');
        $reservas = $this->modelPagos->where('fechaSalida >=',$date)->whereIn('idServicio',$arrayServicioAnfitrion)->findAll();
        $historial = $this->modelPagos->where('fechaSalida <',$date)->whereIn('idServicio',$arrayServicioAnfitrion)->findAll();
