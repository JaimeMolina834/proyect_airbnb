...
/*--Funcin para iniciar sesion---------------------------------------------------------------------------*/
    public function signin(){
        ...
        if($this->modelUsuario->asignarVistaDosRol == $this->configs->defaultRolUsuario){
            return redirect()->route('hazteAnfitrion')->with('msg',[
                'type'=>'warning',
                'body'=>'Debe registrarse como anfitrión.']);
        ...
        if($this->modelUsuario->asignarVistaDosRol == $this->configs->defaultRolAnfitrion){
        ...
        if($this->modelUsuario->asignarVistaDosRol == $this->configs->defaultRolAdmin){
